# Contributing to Alces Flight Boilerplate

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Alces Flight Boilerplate? Welcome! Please read this
...
You can help Alces Flight Boilerplate by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/alces-flight/alces-flight-boilerplate/issues?state=open)
...
If you find a bug - behaviour of Alces Flight Boilerplate code or documentation
...
[GitHub issue tracker for Alces Flight Boilerplate](https://github.com/alces-flight/alces-flight-boilerplate/issues/new)
to report the issue.
...
We want to improve the quality of Alces Flight Boilerplate and good bug reports are
...
Alces Flight Boilerplate is Open Source and comes without warranty.
...
Alces Flight Boilerplate in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Alces Flight Boilerplate and really improve it. The more
...
applied to Alces Flight Boilerplate itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/alces-flight/alces-flight-boilerplate). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Alces Flight Boilerplate developers also have their regular
